...
| [Shops (nb-shops)](nb-shops/index.md) | Tiendas configurables desde un wizard de 4 pasos in-game: civil, business (por trabajo) o illegal (por gang), con stock, categorias, multiples metodos de pago y items como moneda. |
| [Gang Wars (nb-gangwars)](nb-gangwars/index.md) | Captura de territorios para bandas con mecanica de 3 fases, recompensas por zona, rotacion automatica y panel admin Vue 3 para CRUD de zonas. |
| [Actions (nb-actions)](nb-actions/index.md) | Panel contextual de acciones rapidas para policia y EMS: esposar, arrastrar, meter en vehiculo, checks de identidad y licencias, consulta de duenos de vehiculos y registro de inventario. Permisos por grupo / job / identificador. |
| [Billings (nb-billings)](nb-billings/index.md) | Sistema de facturacion standalone con pagos parciales, impuestos por categoria, integracion con sociedades de trabajo, overdue automatico y auditoria de pagos. |
| [Car Dealer (nb-cardealer)](nb-cardealer/index.md) | Concesionarios multi-job donde los jugadores venden sus vehiculos con negociacion (accept / reject / contra-oferta), stock compartido y showroom persistente en el mundo. |
| [Restaurants (nb-restaurants)](nb-restaurants/index.md) | Sistema de restaurantes configurable in-game: panel admin, plantillas de recetas, mesas de crafteo, autoservicio, facturacion y lavado de dinero opcional. Integraciones opt-in con nb-jobmanagers, nb-billings, nb-shops y nb-consumibles. |
| [Warehouse (nb-warehouse)](nb-warehouse/index.md) | Almacenes de facción/negocio, mercado negro y de jugador (compra, renta, mejora de nivel, robo server-validado con skillcheck, contraseña de acceso) con creador in-game y base de datos autoinstalable. |
